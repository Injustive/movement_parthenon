...
class AptosClient:
    def __init__(self, rest_api_url: str, proxy: str):
        self.rest_api_url = rest_api_url
        self.client = CustomRestClient(rest_api_url, proxy)


class CustomRestClient(RestClient):
    def __init__(self, base_url: str, proxy: str, client_config: ClientConfig = ClientConfig()):
